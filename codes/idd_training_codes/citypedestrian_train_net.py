...
def do_train(cfg, model, resume=False):
    ...
    with EventStorage(start_iter) as storage:
        for data, iteration in zip(data_loader, range(start_iter, max_iter)):
            ...
            if (
                ...
                if comm.is_main_process():
                   ...
                   if not bool(val_dict['bboxcmdict']):
                      print("Empty stat dict at ", iteration)
            ...
            if iteration - start_iter > 5 and (iteration % 3946 == 0 or iteration == max_iter):
...
def dict_to_xlsx(cmdict):
    ...
    wb = xw.Workbook('/ssd_scratch/cvit/myfolder/cityped/models/bestcmstat.xlsx')
    wk = wb.add_worksheet()
    row = 0
    col = 0
...
def setup(args):
    ...
    cfg.MODEL.WEIGHTS = "/ssd_scratch/cvit/myfolder/idd_data_coco/models_run1/model_0039999_weights.pth" # Cascade model_final_480dd8.pkl
    cfg.OUTPUT_DIR = '/ssd_scratch/cvit/myfolder/idd_data_coco/models/'
    cfg.MODEL.MASK_ON = False
    cfg.DATALOADER.NUM_WORKERS = 1
    cfg.SOLVER.MAX_ITER = 118380
    cfg.SOLVER.CHECKPOINT_PERIOD = 5000
    #cfg.INPUT.MIN_SIZE_TRAIN = (800,)
    cfg.SOLVER.BASE_LR = 0.001 # pick a good LR
    cfg.SOLVER.GAMMA = 0.125
    cfg.SOLVER.STEPS = (118381,)

    cfg.SOLVER.LR_SCHEDULER_NAME = "WarmupMultiStepLR"
    cfg.SOLVER.MOMENTUM = 0.9
    #cfg.SOLVER.MIN_LR = 0.00008
    #cfg.SOLVER.MAX_LR = 0.0003
    #cfg.SOLVER.STEP_SIZE_UP = 11838
    #cfg.SOLVER.MAX_MOMENTUM = 0.95

    cfg.TEST.EVAL_PERIOD = 153946
    ...
    register_coco_instances("cityped_train", {}, "/ssd_scratch/cvit/myfolder/cityscapes/citypedestrian_train_gt.json", "/ssd_scratch/cvit/myfolder/cityscapes/leftImg8bit/train")
    register_coco_instances("cityped_val", {}, "/ssd_scratch/cvit/myfolder/cityscapes/citypedestrian_eval_gt.json", "/ssd_scratch/cvit/myfolder/cityscapes/leftImg8bit/val")
    return cfg
...
def remove_solver_states(model_path):
    ...
    del model["iteration"]
    print(list(model.keys()))
    torch.save(model, '/ssd_scratch/cvit/myfolder/cityscapes/models/cityped/model_only_weights.pth')
...
def main(args):
    ...
    do_train(cfg, model)
    model_path = '/ssd_scratch/cvit/myfolder/cityscapes/models/cityped/model_final.pth'
    if comm.is_main_process():
    	remove_solver_states(model_path)
        print("All done")
