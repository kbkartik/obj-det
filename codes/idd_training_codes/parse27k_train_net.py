...
def setup(args):
    ...
    cfg.DATASETS.TRAIN = ("parse_train",)
    cfg.DATASETS.TEST = ("parse_val",)
    #cfg.MODEL.WEIGHTS = "/ssd_scratch/cvit/myfolder/my_parse27k_dataset/model_final_480dd8.pkl" # Cascade
    #cfg.MODEL.WEIGHTS = "/ssd_scratch/cvit/myfolder/person_idd_data/model_final_f6e8b1.pkl" # Faster
    cfg.OUTPUT_DIR = '/ssd_scratch/cvit/myfolder/models/'
    cfg.MODEL.WEIGHTS = '/ssd_scratch/cvit/myfolder/models_cp_parse27k/model_only_weights.pth'
    cfg.MODEL.MASK_ON = False
    cfg.DATALOADER.NUM_WORKERS = 1
    cfg.SOLVER.CHECKPOINT_PERIOD = 7000
    cfg.TEST.EVAL_PERIOD = 700
    cfg.SOLVER.IMS_PER_BATCH = 7
    cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.5
    cfg.SOLVER.BASE_LR = 0.00008  # pick a good LR
    ...
    register_coco_instances("parse_train", {}, "/ssd_scratch/cvit/myfolder/my_parse27k_dataset/train_parse27k.json", "/ssd_scratch/cvit/myfolder/my_parse27k_dataset/train")
    register_coco_instances("parse_val", {}, "/ssd_scratch/cvit/myfolder/my_parse27k_dataset/val_parse27k.json", "/ssd_scratch/cvit/myfolder/my_parse27k_dataset/val")
    return cfg
...
def remove_solver_states(model_path):
    ...
    del model["iteration"]
    print(list(model.keys()))
    torch.save(model, '/ssd_scratch/cvit/myfolder/models_cp_parse27k/model_only_weights.pth')
